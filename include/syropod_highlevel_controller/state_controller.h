...
public:
  ...
  /// @param[in] use_default_joint_positions Flag indicating whether to use default joint positions or not
  ...
  /// @param[in] target_body_pose The desired configuration that the planner requests the body transition to
